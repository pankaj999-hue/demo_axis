  ...
  return (
    <div style={{ fontFamily: "'DM Sans', 'Helvetica Neue', Arial, sans-serif", color: "#0f1f3d", background: "#fff", minHeight: "100vh" }}>
      ...
      <section id="home" className="hero-section" style={{
        ...
        <div style={{ position: "absolute", top: -100, right: -100, width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle, rgba(26,86,219,0.1) 0%, transparent 70%)", pointerEvents: "none", animation: "pulse 15s infinite alternate" }} />
        <div style={{ position: "absolute", bottom: -150, left: -150, width: 500, height: 500, borderRadius: "50%", background: "radial-gradient(circle, rgba(59,130,246,0.1) 0%, transparent 70%)", pointerEvents: "none", animation: "pulse 12s infinite alternate-reverse" }} />
        <style>{`
          @keyframes pulse {
          ...
          <div className="section-container">
            ...
            <div className="hero-form" style={{ display: "flex", justifyContent: "flex-end" }}>
              <div className="hero-form-container">
                ...
                <p style={{ fontSize: 15, fontWeight: 600, color: "#334155", marginBottom: 32, lineHeight: 1.6 }}>Tell us what you need and we'll open a WhatsApp chat for you instantly.</p>
